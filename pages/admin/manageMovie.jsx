...
class ManageMovie extends React.Component{
    ...
    onBtnSaveEditClick = () => {
        ...
        var seats = this.refs.input8.value
        var booked = this.refs.input9.value
        ...
        if(title === '' || 
           ...
           seats <= 0)
           {
            ...
            var data = {
                title, sutradara,image,genre,playingAt,duration,sinopsis,seats
            }
            ...
            if(val.id === this.state.selectedEdit){
                return(
                    <TableRow>
                        ...
                        <TableCell><input ref='input8' className='form-control' type='text' defaultValue={val.seats} /></TableCell>
    ...
    onBtnSaveClick = () => {
        ...
        console.log(playingAt)
            ...
            var booked = this.refs.booked.value
                ...
                {/* MODAL START */}
                    ...
                    <Modal isOpen={this.state.modalOpen} toggle={this.closeModal}>
                        ...
                        <ModalBody>
                            ...
                            <input ref='seats' type='text' className='form-control mt-2' placeholder='seats' />
                            <div className='mt-3'>
